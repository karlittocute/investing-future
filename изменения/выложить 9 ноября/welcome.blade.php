...
<div class="main">
	...
	<section id="registration" class="bluesection">
		<div class="container">
				...
				<div class="col-md-6">
					...
					<div class="row text-center">
						...
						<div class="row text-center">
							...
							@if (Auth::check())
								@if (!Auth::user()->seminar_11_11_2017)
									<h6>Вы не записаны на семинар</h6>
									<form id="seminar_11_11_2017" name="seminar_11_11_2017" method="POST" action="/seminar_11_11_2017">
									{{ csrf_field()}}
									<button type="submit" id="submitseminar_11_11_2017" name="submitseminar_11_11_2017" type="button" class="btn btn-default">Записаться</button>
									</form>
								@elseif (Auth::user()->seminar_11_11_2017->status==0)
			...
			<div class="row features">
				<div class="text-center">
				<h4><a align="center" href="{{ URL::asset('/place') }}">Место проведения:</br> Ростов-на-Дону, ул. Города Волос 135 / пр. Журавлева 136</a></h4>
				<div class="hidden-xs  ">
					<button class="shine" type="button" data-toggle="modal" data-target=".bs-example-modal-lgb"><img src="{{ URL::asset('images/place_min2.jpg') }}"></button>
