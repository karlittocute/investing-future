...
<h6 style="font-size: 15pt;">28 Октября с 14:00-16:00</h6>
...
<div class="row text-center">
	...
	@if (Auth::check())
		@if (!Auth::user()->seminar_28_10_2017)
			<h6>Вы не записаны на семинар</h6>
			<form id="seminar_28_10_2017" name="seminar_28_10_2017" method="POST" action="/seminar_28_10_2017">
			{{ csrf_field()}}
			<button type="submit" id="submitseminar_28_10_2017" name="submitseminar_28_10_2017" type="button" class="btn btn-default">Записаться</button>
			</form>
		@elseif (Auth::user()->seminar_28_10_2017->status==0)
