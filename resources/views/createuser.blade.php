...
@section('content')
 ...
 <form id="user" name="user" method="POST" action="/user">
		...
		<div class="form-group">
			<label for="surname">Фамилия<sup><i class="fa fa-asterisk" style="color: #c0392b;"></i></sup></label>
			<input id="surname" name="surname" type="text" class="form-control" placeholder="Иванов" required>
		</div>
		<div class="form-group">
			<label for="name">Имя<sup><i class="fa fa-asterisk" style="color: #c0392b;"></i></sup></label>
			<input id="name" name="name" type="text" class="form-control" placeholder="Иван" required>
		</div>
		<div class="form-group">
			<label for="phone">Номер телефона<sup><i class="fa fa-asterisk" style="color: #c0392b;"></i></sup></label>
			<input id="phone" name="phone" type="text" class="form-control" placeholder="80123456789"  required>
		</div>
		<div class="form-group">
		...
		<div class="form-group">
			<input type="checkbox" required checked name="terms"> Я принимаю <a href="{{ URL::asset('privacy_policy_investing-future.pdf') }}">Политику конфиденциальности</a></p>
		</div>
		@include('errors')
		<button type="submit" id="submitResume" name="submitResume" type="button" class="btn btn-lg btn-block">Зарегистрироваться</button>
